...
class MainModel extends ChangeNotifier {// ChangeNotifierの挙動は, このクラスのインスタンスが変更された時に, notifyListeners()を呼び出すというものです。
  List<Todo> todoList = [];// ここから追加
  String newTodoText = '';// ここから追加

  Future getTodoList() async {// ここから追加
    final snapshot =//
